  ...
  return (
    <div className="">
      <div className="relative ">
        ...
        <div className="absolute top-0 py-20 flex flex-col sm:flex-row justify-between w-full h-screen">
          <div className="ml-20">
            <Image src={frame90} alt="" className="w-[136px] h-[58px] sm:w-[235px] sm:h-[100.65px]" />
