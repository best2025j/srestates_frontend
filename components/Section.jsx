...
export const Section = () => {
  return (
    <div>
      <div className="py-20 px-[36px] sm:px-16 h-screen w-full font-['Ubuntu']">
          ...
          <div className="flex md:flex-row flex-col justify-between items-center">
            <div className="space-y-5 h-full justify-center items-center">
              ...
              <p className="sm:max-w-md max-w-[253px] text-sm md:text-2xl font-normal">
                ...
                roommates you can find around you. Sign up, fill out your
                profile and get paired to your dream roommate.
              </p>
